...
extension Font {
  ...
  /// heading
    static let heading3_bold24: Font = .custom("Pretendard-Bold", size: 24.adjusted)
    static let heading5_semibold18: Font = .custom("Pretendard-SemiBold", size: 18.adjusted)
    static let heading6_semibold16: Font = .custom("Pretendard-SemiBold", size: 16.adjusted)
    static let heading7_medium16: Font = .custom("Pretendard-Medium", size: 16.adjusted)
  
  /// subTitle
    static let subTitle1_semibold14: Font = .custom("Pretendard-SemiBold", size: 14.adjusted)
